...
export default function TitleJobs() {
    ...
    useEffect(() => { // שימוש ב-useEffect להפעלת הקוד כשהתגובות משתנות
      const locations = responses.map(response => response.jobTitle).filter(Boolean); // מיפוי התגובות להוצאת מקומות המגורים וסינון ערכים ריקים
